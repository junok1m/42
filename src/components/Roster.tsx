...
const Roster: React.FC<RosterProps> = ({ rosterToday, rosterTomorrow, loading = false }) => {
  ...
  }, [activeTab, selectedNationalities, selectedServices, searchParams, setSearchParams]);
...
if (selectedServices.length > 0) {
  filtered = filtered.filter((m) => {
    ...
    return filtered;
  }, [currentRoster, selectedNationalities, selectedServices]);
...
{/* Tomorrow roster release message (empty array before 7pm is normal) */}
...
/>
  ...
  {t("roster.loadingSubtitle")}
            ...
            <>
              <RosterGrid models={filteredRoster} activeTab={activeTab as "today" | "tomorrow"} />
